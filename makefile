...
$(PROGRAM_NAME): main.o initialise.o ObjectNodes.o CameraClass.o DrawingClass.o ObjectPickerClass.o SceneGraph.o AnimationNodes.o BackdropClass.o CollisionClass.o  ObjLoaderClass.o lodepng.o TGALoader.o
	$(CC) -o $@ $^ $(CFLAGS) $(LDFLAGS)
